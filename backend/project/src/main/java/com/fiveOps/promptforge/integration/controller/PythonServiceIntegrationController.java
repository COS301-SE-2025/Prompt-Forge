...
public class PythonServiceIntegrationController {
    ...
    public ResponseEntity<Map<String, Object>> testAiHealth() {
        ...
        try {
            ResponseEntity<Object> response = restTemplate.getForEntity(
                aiServiceUrl + "/health", Object.class);
    ...
    public ResponseEntity<Map<String, Object>> testMlHealth() {
        ...
        try {
            ResponseEntity<Object> response = restTemplate.getForEntity(
                mlServiceUrl + "/health", Object.class);
            
            result.put("status", "success");
            result.put("mlService", Map.of(
    ...
    public ResponseEntity<Map<String, Object>> testAllHealth() {
        ...
        // Test AI Service
        try {
            ResponseEntity<Object> aiResponse = restTemplate.getForEntity(
                aiServiceUrl + "/health", Object.class);
        ...
        // Test ML Service
        try {
            ResponseEntity<Object> mlResponse = restTemplate.getForEntity(
                mlServiceUrl + "/health", Object.class);
            services.put("mlService", Map.of(
                "status", "healthy",
    ...
    public ResponseEntity<Map<String, Object>> testAiClassify(@RequestBody Map<String, Object> request) {
        Map<String, Object> result = new HashMap<>();
        ...
        try {
            ...
            ResponseEntity<Object> response = restTemplate.postForEntity(
                aiServiceUrl + "/classify", entity, Object.class);
    ...
    public ResponseEntity<Map<String, Object>> testMlOptimize(@RequestBody Map<String, Object> request) {
        Map<String, Object> result = new HashMap<>();
        ...
        try {
            ...
            optimizeRequest.put("original_prompt", request.getOrDefault("original_prompt", "make a website"));
            ...
            ResponseEntity<Object> response = restTemplate.postForEntity(
                mlServiceUrl + "/optimize", entity, Object.class);
    ...
    public ResponseEntity<Map<String, Object>> testFullWorkflow(@RequestBody Map<String, Object> request) {
        Map<String, Object> result = new HashMap<>();
        Map<String, Object> workflow = new HashMap<>();
        
        String prompt = (String) request.getOrDefault("prompt", "Create a React component for user authentication");
        ...
        try {
            ...
            Map<String, Object> classifyRequest = Map.of(
                "text", prompt
            );
            
            HttpEntity<Map<String, Object>> classifyEntity = new HttpEntity<>(classifyRequest, headers);
            ResponseEntity<Object> classifyResponse = restTemplate.postForEntity(
                aiServiceUrl + "/classify", classifyEntity, Object.class);
            
            workflow.put("step1_classification", Map.of(
                "status", "success",
                "response", classifyResponse.getBody()
            ));
        ...
        try {
            ...
            Map<String, Object> optimizeRequest = Map.of(
            ...
            ResponseEntity<Object> optimizeResponse = restTemplate.postForEntity(
                mlServiceUrl + "/optimize", optimizeEntity, Object.class);
            
            workflow.put("step2_optimization", Map.of(
                "status", "success",
                "response", optimizeResponse.getBody()
            ));
