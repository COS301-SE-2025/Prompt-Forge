...
@Table(
    ...
    indexes = {
      ...
      @Index(
          name = "idx_analytics_prompt_metrics",
          columnList = "prompt_id, view_count, purchase_count, avg_rating"),
      ...
      @Index(name = "idx_analytics_monthly", columnList = "prompt_id, date"),
      @Index(
          name = "idx_analytics_performance",
          columnList = "view_count, purchase_count, avg_rating")
    })
