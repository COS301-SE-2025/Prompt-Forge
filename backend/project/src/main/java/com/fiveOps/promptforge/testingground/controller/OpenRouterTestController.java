...
public class OpenRouterTestController {
  ...
  public ResponseEntity<?> chat(@RequestBody Map<String, Object> requestBody) {
    try {
      ...
      boolean isStreaming = requestBody.containsKey("stream") && 
  ...
  public ResponseEntity<StreamingResponseBody> 
    chatStream(@RequestBody Map<String, Object> requestBody) {
    // Validate model is present
    if (!requestBody.containsKey("model")) {
  ...
  public ResponseEntity<?> testConnection() {
      try {
          ...
          String testBody = "{\"model\":\"deepseek/deepseek-r1-0528-qwen3-8b:free\"," +
  ...
  private void processStreamContent(OutputStream outputStream, String line, 
                                    int[] contentLines, boolean[] hasContent) throws IOException {
  ...
  private void handleOpenRouterError(OutputStream outputStream, HttpURLConnection connection, 
    ...
    String errorJson = "data: {\"error\":{\"message\":\"OpenRouter error: " + 
                       escapedError + "\"}}\n\n";
  ...
  private StreamingResponseBody createStreamingResponse(Map<String, Object> requestBody) {
    return outputStream -> {
        ...
        try {
            ...
            try {
                String escapedError = e.getMessage() != null ? 
