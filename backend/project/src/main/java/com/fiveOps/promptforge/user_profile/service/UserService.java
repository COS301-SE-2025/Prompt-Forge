...
public class UserService {
    ...
    public UserDto updateUser(UUID id, UpdateProfileDto dto) {
        ...
        if (dto.getProfilePicture() != null) {
            user.setProfilePictureUrl(dto.getProfilePicture()); // Entity uses profilePictureUrl
        }
    ...
    private UserDto mapToDto(User user) {
        ...
        dto.setProfilePicture(user.getProfilePictureUrl()); // Maps entity's profilePictureUrl to DTO's profilePicture
