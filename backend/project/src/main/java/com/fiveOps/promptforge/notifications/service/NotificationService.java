...
public class NotificationService {
  ...
  public Notification createNotification(
      User user, UUID promptId, String type, String title, String message) {
      ...
      if (bounceRate > 75.0) {
        ...
        if (promptOwner != null) {
          ...
          boolean recentAlertExists =
              notificationRepository.existsByUserAndPromptIdAndTypeAndCreatedAtAfter(
          ...
          if (!recentAlertExists) {
            ...
            createNotification(promptOwner, prompt.getId(), BOUNCE_RATE_ALERT, title, message);
      ...
      if (promptOwner != null && !promptOwner.getUserId().equals(interactingUser.getUserId())) {
        ...
        switch (action) {
          case "VIEW":
            ...
            message =
                String.format(
                    "%s viewed your prompt '%s'", interactingUser.getUsername(), prompt.getTitle());
            break;
          case "ADD_TO_CART":
            ...
            message =
                String.format(
                    "%s added your prompt '%s' to their cart",
