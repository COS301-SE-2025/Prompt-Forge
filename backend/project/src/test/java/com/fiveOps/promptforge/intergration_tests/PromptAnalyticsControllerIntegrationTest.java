...
class PromptAnalyticsControllerIntegrationTest {
  ...
  private final String TEST_EMAIL = "analyticsuser@integration.com";
  private final String TEST_PASSWORD = "analyticsPass123";
  private final String TEST_USERNAME = "AnalyticsUser";
  private final String TEST_PROMPT_CONTENT = "Test analytics prompt content";

  private UUID userId;
  private String authToken;
  private UUID publicPromptId;
  private UUID featuredPromptId;
