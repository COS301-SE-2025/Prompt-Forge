...
class S3ServiceTest {
  ...
  void uploadFile_Success() throws IOException {
    MockMultipartFile file =
        new MockMultipartFile("file", TEST_FILE_NAME, TEST_CONTENT_TYPE, TEST_CONTENT.getBytes());
  ...
  void uploadFile_WithNullContentType() throws IOException {
    MockMultipartFile file =
        new MockMultipartFile("file", TEST_FILE_NAME, null, TEST_CONTENT.getBytes());
  ...
  void uploadFile_WithEmptyFileName() throws IOException {
    MockMultipartFile file =
        new MockMultipartFile("file", "", TEST_CONTENT_TYPE, TEST_CONTENT.getBytes());
  ...
  void uploadFile_WithLargeFile() throws IOException {
    ...
    MockMultipartFile file =
        new MockMultipartFile("file", "large-file.bin", "application/octet-stream", largeContent);
  ...
  void deleteFile_WithComplexKey() {
    String fileUrl =
        "https://" + BUCKET_NAME + ".s3.amazonaws.com/folder/subfolder/complex-file-name-123.txt";
    DeleteObjectResponse deleteObjectResponse = DeleteObjectResponse.builder().build();
  ...
  void deleteFile_WithUrlContainingQueryParameters() {
    String fileUrl =
        "https://" + BUCKET_NAME + ".s3.amazonaws.com/test-file.txt?versionId=123&expires=456";
    DeleteObjectResponse deleteObjectResponse = DeleteObjectResponse.builder().build();
  ...
  void uploadFile_WithSpecialCharactersInFileName() throws IOException {
    ...
    MockMultipartFile file =
        new MockMultipartFile(
            "file", fileNameWithSpecialChars, TEST_CONTENT_TYPE, TEST_CONTENT.getBytes());
