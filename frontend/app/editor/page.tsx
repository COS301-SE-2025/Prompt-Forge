...
- Be approximately 150 words`}
          ...
          <div className="mt-4 flex justify-between">
            <div className="text-xs text-muted-foreground">0 Characters</div>
            <div className="flex space-x-2">
              <Button variant="outline" size="sm" className="h-8">
                <Save className="h-4 w-4 mr-1" />
                Save as Preset
              </Button>
              <Button size="sm" className="h-8 bg-[hsl(var(--forge-green))] hover:bg-[hsl(var(--forge-green-dark))]">
          ...
          <div className="flex-1 flex flex-col space-y-4">
            <Card className="bg-card border-border p-4">
              <div className="flex items-start space-x-2">
                <div className="bg-[hsl(var(--forge-green))]/20 rounded p-1">
                  <Sparkles className="h-4 w-4 text-[hsl(var(--forge-green))]" />
                </div>
