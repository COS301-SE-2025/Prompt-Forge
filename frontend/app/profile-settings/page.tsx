                ...
                <Card className="p-6">
                    ...
                    <div className="flex flex-col items-center">
                      <div className="relative mb-4">
                        ...
                        <div className="absolute -bottom-2 -right-2">
                          <div className="bg-[hsl(var(--forge-green))] rounded-full p-1.5 cursor-pointer">
                  ...
                  <div className="border-t border-border pt-4">
                    <div className="flex justify-between items-center">
                      ...
                      <Button
                        onClick={handleSave}
                        className="bg-[hsl(var(--forge-green))] hover:bg-[hsl(var(--forge-green-dark))]"
                      >
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center">
                        <Check className="h-4 w-4 text-[hsl(var(--forge-green))] mr-2" />
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <div className="h-2 bg-muted rounded-full overflow-hidden">
                        <div
                          className="h-full bg-[hsl(var(--forge-green))] rounded-full"
                          style={{ width: "25%" }}
                        ></div>
                      </div>
                    </div>
