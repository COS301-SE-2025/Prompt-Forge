...
void mainImage(out vec4 fragColor,in vec2 fragCoord){
    ...
    vec3 finalColor = mix(bg, mid, punch * 0.5);
    finalColor = mix(finalColor, accent, punch);
...
export default function Silk({
  ...
  return (
    <canvas
      ref={ref}
      className={className || "silk-canvas"}
      style={style}
    />
  )
}

// Add this to your CSS (e.g., Silk.css or global styles):
// .silk-canvas { width: 100%; height: 100%; display: block; }
