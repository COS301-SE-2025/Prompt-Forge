          ...
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <div className="relative">
                <Sparkles className="h-12 w-12 text-[#40ffaa] dark:text-[#4079ff] animate-pulse" />
                {/* Replace rounded pulse with a star pulse */}
                <Star
                  className="absolute -top-1 -right-1 h-4 w-4 text-[#40ffaa] dark:text-[#4079ff] animate-pulse"
                  style={{
            ...
            <h1 className="text-4xl md:text-5xl font-medium bg-gradient-to-r from-[#40ffaa] via-[#4079ff] to-[#40ffaa] bg-clip-text text-transparent mb-4">
              AI Prompt Optimizer
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <Card className="p-6 bg-card/80 dark:bg-card/80 backdrop-blur-sm border-border shadow-xl">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 bg-muted dark:bg-muted rounded-lg">
                  <Target className="h-5 w-5 text-foreground dark:text-foreground" />
                </div>
                <h2 className="text-xl font-semibold text-foreground dark:text-foreground">Your Original Prompt</h2>
              </div>
              ...
              <Textarea
                ...
                className="min-h-[200px] resize-none border-border dark:border-border focus:border-[#40ffaa] dark:focus:border-[#4079ff] transition-colors bg-muted dark:bg-muted placeholder:text-grey"
                />

              <div className="flex items-center justify-between mt-4">
                <div className="text-sm text-muted-foreground">{originalPrompt.length} characters</div>
                <Button
                  onClick={handleGenerateSuggestions}
                  disabled={isGenerating || !originalPrompt.trim()}
                  className="bg-gradient-to-r from-[#40ffaa] to-[#4079ff] hover:from-[#4079ff] hover:to-[#40ffaa] text-foreground font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                >
                  {isGenerating ? (
                    <>
            ...
            <div className="grid grid-cols-3 gap-4">
              <Card className="p-4 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-slate-200 dark:border-slate-700 text-center">
                <Zap className="h-6 w-6 text-yellow-500 mx-auto mb-2" />
                <div className="text-2xl font-bold text-slate-800 dark:text-slate-200">3.2x</div>
              ...
              <Card className="p-4 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-slate-200 dark:border-slate-700 text-center">
                ...
                <div className="text-2xl font-bold text-slate-800 dark:text-slate-200">4.9</div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-2 bg-gradient-to-r from-[#4079ff]/20 to-[#40ffaa]/20 dark:from-[#4079ff]/30 dark:to-[#40ffaa]/30 rounded-lg">
                <Sparkles className="h-5 w-5 text-[#4079ff] dark:text-[#40ffaa]" />
              </div>
              <h2 className="text-xl font-semibold text-foreground dark:text-foreground">Optimized Suggestions</h2>
            </div>
            ...
            {isGenerating && (
              <div className="space-y-4">
                {[1, 2, 3].map((i) => (
                  <Card
                    key={i}
                    className="p-6 bg-card/80 dark:bg-card/80 backdrop-blur-sm border-border"
                  >
                    <div className="animate-pulse">
                      <div className="flex items-center gap-3 mb-4">
                        <div className="h-4 w-4 bg-muted dark:bg-muted rounded"></div>
                        <div className="h-4 bg-muted dark:bg-muted rounded flex-1"></div>
                        <div className="h-6 w-12 bg-muted dark:bg-muted rounded-full"></div>
                      </div>
            ...
            {showSuggestions && suggestions.length > 0 && (
              <div className="space-y-4">
                {suggestions.map((suggestion, index) => (
                  <Card
                    key={suggestion.id}
                    className={`p-6 bg-card/80 dark:bg-card/80 backdrop-blur-sm border-border shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-[1.02] cursor-pointer ${
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <Badge
                          variant="secondary"
                          className="bg-gradient-to-r from-[#40ffaa]/20 to-[#4079ff]/20 dark:from-[#40ffaa]/30 dark:to-[#4079ff]/30 text-[#4079ff] dark:text-[#40ffaa]"
                        >
                          {suggestion.category}
                        </Badge>
                        <h3 className="font-semibold text-foreground dark:text-foreground">{suggestion.title}</h3>
                      </div>
                      <div className="flex items-center gap-2">
                        <Badge className="bg-gradient-to-r from-[#40ffaa] to-[#4079ff] text-background">
                          {suggestion.score}%
                        </Badge>
                        <ChevronRight
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {suggestion.improvements.slice(0, 2).map((improvement, i) => (
                        <Badge key={i} variant="outline" className="text-xs border-[#40ffaa] dark:border-[#4079ff] text-[#4079ff] dark:text-[#40ffaa]">
                          {improvement}
                        </Badge>
                      ))}
                      {suggestion.improvements.length > 2 && (
                        <Badge variant="outline" className="text-xs border-[#40ffaa] dark:border-[#4079ff] text-[#4079ff] dark:text-[#40ffaa]">
                    ...
                    {selectedSuggestion === suggestion.id && (
                      <div className="space-y-4 animate-fadeIn">
                        <div className="bg-muted dark:bg-muted/50 rounded-lg p-4">
                          <h4 className="font-medium text-foreground dark:text-foreground mb-2">Optimized Prompt:</h4>
                        ...
                        <div>
                          <h4 className="font-medium text-foreground dark:text-foreground mb-2">Key Improvements:</h4>
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            {suggestion.improvements.map((improvement, i) => (
                              ...
                              >
                                <Check className="h-3 w-3 text-[#40ffaa]" />
                                {improvement}
                              </div>
                            ))}
                          </div>
                        ...
                        <div className="flex gap-3 pt-4 border-t border-border">
                          ...
                          >
                            {copiedId === suggestion.id ? <Check className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                          </Button>
                        </div>
                      </div>
                    )}
            ...
            {!isGenerating && suggestions.length === 0 && originalPrompt && (
              <Card className="p-8 bg-card/80 dark:bg-card/80 backdrop-blur-sm border-border text-center">
                <Wand2 className="h-12 w-12 text-[#4079ff] dark:text-[#40ffaa] mx-auto mb-4" />
                <h3 className="text-lg font-medium text-foreground dark:text-foreground mb-2">Ready to Optimize</h3>
