        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex-1 flex flex-col items-center">
              ...
              <p className="text-muted-foreground text-md whitespace-nowrap overflow-x-auto max-w-full">
                Transform your prompts into high-performance masterpieces
              </p>
            </div>
            {/* Help and Back buttons on far right */}
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 custom-scrollbar">
          <div className="bg-background border border-border rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-background border-b border-border p-4 flex items-center justify-between">
              <h2 className="text-xl font-bold text-foreground">Optimizer Wizard Complete Guide</h2>
              <Button
                variant="ghost"
                size="icon"
            ...
            <div className="p-6 space-y-8">
              ...
              <section>
                ...
                <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
                  <li><strong>Analysis:</strong> Enter your prompt and let our AI analyze its strengths and weaknesses.</li>
                  <li><strong>Goals:</strong> Define your objectives, target audience, and desired output format.</li>
                  <li><strong>Structure:</strong> Choose organizational improvements like bullet points, introductions, and examples.</li>
                  <li><strong>Context:</strong> Add domain-specific information and constraints to refine your prompt.</li>
                  <li><strong>Testing:</strong> Validate your optimized prompt with AI model testing.</li>
                  <li><strong>Review:</strong> Compare before/after results and save your optimized prompt.</li>
                </ol>
              </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    },
                    {
                      ...
                      details: "Share relevant context about your project, constraints, or goals. This helps the AI provide more tailored and useful responses."
                    }
                  ].map((tip, index) => (
                    <Card
                      key={index}
                  ...
                  {[
                    {
                      ...
                      after: "Write a compelling 500-word science fiction short story about a sentient robot who discovers emotions for the first time. Include vivid descriptions, dialogue, and a surprising twist ending.",
                      improvement: "Added specificity, word count, genre, emotional arc, and structural requirements"
                    },
                    {
                      category: "Business",
                      before: "Create a marketing plan.",
                      after: "Develop a comprehensive 90-day digital marketing strategy for a B2B SaaS startup targeting small businesses. Include budget allocation, channel selection, KPIs, and monthly milestones.",
                    ...
                    },
                    {
                      ...
                      after: "Create a beginner-friendly explanation of quantum physics fundamentals for high school students. Use analogies, avoid complex equations, include 3 real-world applications, and end with discussion questions.",
                    ...
                    },
                    {
                      ...
                      after: "Create a responsive React.js component for a user dashboard with authentication, data visualization using Chart.js, and mobile-first design. Include TypeScript types and error handling.",
                      improvement: "Specified technology stack, features, design approach, type safety, and error management"
                    }
                  ].slice(0, showAllExamples ? 4 : 2).map((example, index) => {
                    const tagColors = [
                      ...
                      <Card key={index} className="p-6 bg-card/60">
                        ...
                        <div className="space-y-4">
                          <div className="bg-red-50 dark:bg-red-900/10 rounded-lg p-4 border border-red-200 dark:border-red-800">
                            ...
                            <p className="text-sm text-red-600 dark:text-red-300 font-mono">"{example.before}"</p>
                          </div>
